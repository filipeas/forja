...
import numpy as np
import progressbar
from REMOVER.utils import batch_iterator
from REMOVER.utils.Plot import bar_widgets
...
class Network():
    ...
    def setTrainable(self, trainable):
        """
        Method which enables freezing of the wights of the network's layers.
        """
    ...
    def add(self, layer):
        ...
        to the outpu shape of the last added layer.
        """
        if self.layers:
